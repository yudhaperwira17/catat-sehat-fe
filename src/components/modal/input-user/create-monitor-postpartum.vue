...
const rules: FormRules = {
  dayPostPartumId: [{ type: 'string', required: true, message: 'Minggu kehamilan wajib diisi' }],
  ...
  question14: [{ type: 'boolean', required: true, message: 'Pertanyaan wajib diisi' }],
  question15: [{ type: 'boolean', required: true, message: 'Pertanyaan wajib diisi' }],
  question16: [{ type: 'boolean', required: true, message: 'Pertanyaan wajib diisi' }],
  question17: [{ type: 'boolean', required: true, message: 'Pertanyaan wajib diisi' }],
  question18: [{ type: 'boolean', required: true, message: 'Pertanyaan wajib diisi' }]
}
      ...
      >
        ...
        <div class="space-y-6">
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <n-radio-group
              v-model:value="formData.question14"
              class="flex flex-col space-y-2"
              path="question14"
            >
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <n-radio-group
              v-model:value="formData.question15"
              class="flex flex-col space-y-2"
              path="question15"
            >
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <n-radio-group
              v-model:value="formData.question16"
              class="flex flex-col space-y-2"
              path="question16"
            >
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <n-radio-group
              v-model:value="formData.question17"
              class="flex flex-col space-y-2"
              path="question17"
            >
              <n-radio :value="false" class="text-sm"
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <n-radio-group
              v-model:value="formData.question18"
              class="flex flex-col space-y-2"
              path="question18"
            >
              <n-radio :value="false" class="text-sm"
