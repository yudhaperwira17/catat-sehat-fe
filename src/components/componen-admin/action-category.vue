...
import EditData from '@/components/modal/input-admin/Edit-Category.vue'
import { API } from '@/composable/http/api-constant'
import { useAdminDeleteCategory } from '@/services/bmi-category'
...
const { mutate } = useAdminDeleteCategory(props.id)
