...
const { data: report, isLoading } = useReadDetailReportById(computed(() => props.id))
</script>
      ...
      <div class="overflow-y-auto max-h-[calc(90vh-200px)]">
        ...
        <div v-else class="p-6">
          ...
          <div class="text-center mb-8 p-6 bg-green-50 rounded-xl border border-green-100">
            ...
            <h3 class="text-lg font-semibold text-gray-900 mb-2">Terima Kasih atas Laporan Anda</h3>
            <p class="text-sm text-gray-600">
              Laporan Anda sangat berharga untuk membantu mengatasi stunting
            </p>
          </div>
