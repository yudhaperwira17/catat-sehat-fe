...
const columns: DataTableColumns<Daum> = [
  ...
  {
    title: 'KONSUMSI TABLET TAMBAH DARAH',
    key: 'upcomingVaccine',
    render(row: Daum) {
    ...
    <div class="flex md:flex-row md:items-center mb-6 flex-col gap-y-2 md:justify-between">
      ...
      <div class="w-full md:w-auto flex justify-end">
        <div class="w-28 mt-6">
            ...
            <n-select
              :options="[
                { label: 'Hari ke', disabled: true, value: '' },
                { label: 'Hari 1', value: '1' },
                { label: 'Hari 2', value: '2' }
              ]"
              placeholder="Hari ke"
              v-model:value="selectedChild"
              default-value="Hari 1"
              size="small"
            />
          </div>
        </div>
