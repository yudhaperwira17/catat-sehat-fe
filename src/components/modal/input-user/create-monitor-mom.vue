...
const formData = ref<FormData>({
  ...
  weekPregnancyMonitoringId: undefined,
  question1: undefined,
  question2: undefined,
  question3: undefined,
  question4: undefined,
        ...
        <div class="space-y-6">
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <n-radio-group v-model:value="formData.question8" class="flex flex-col space-y-2">
              ...
              <n-radio :value="false" class="text-sm"
                >Tidak Ada Batuk Lebih dari 2 minggu atau kontak serumah dengan penderita
                tb</n-radio
              >
            </n-radio-group>
          </div>
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <n-radio-group v-model:value="formData.question11" class="flex flex-col space-y-2">
              ...
              >
              <n-radio :value="true" class="text-sm">Sangat banyak atau berbau</n-radio>
            </n-radio-group>
          </div>
