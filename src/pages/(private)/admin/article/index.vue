  ...
  <div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="flex justify-end mb-6">
      <div class="flex items-center">
        ...
        <n-button type="primary" class="bg-blue-600 text-white px-4 py-1 hover:bg-blue-700 rounded-md ml-2" @click="openCreateModal">
          Tambah Artikel
        </n-button>
      </div>
    </div>
      ...
      >
        ...
        <div class="p-4 flex flex-col flex-grow">
          ...
          <div class="mt-auto space-y-2">
            <n-button class="w-full bg-blue-600 text-white text-sm py-2 rounded hover:bg-blue-700" @click="goToDetail(article.id)">
              Detail
            </n-button>
            <n-button
